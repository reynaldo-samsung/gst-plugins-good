...
gst_matroska_parse_finalize (GObject * object)
{
  ...
  gst_matroska_read_common_finalize_ctx (&parse->common);
...
gst_matroska_parse_init (GstMatroskaParse * parse)
{
  ...
  gst_matroska_read_common_init_ctx (&parse->common);
...
gst_matroska_parse_reset (GstElement * element)
{
  ...
  gst_matroska_read_common_reset_ctx (GST_ELEMENT (parse), &parse->common);
